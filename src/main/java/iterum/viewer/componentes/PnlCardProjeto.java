...
public class PnlCardProjeto extends javax.swing.JPanel {
    ...
    private void aplicarProjetoNoCard() {
        ...
        int progresso = totalTarefas == 0 ? 0 : Math.round((concluidas * 100f) / totalTarefas);
        pbProgresso.setValue(progresso);
        lblTarefas.setText(totalTarefas + " tarefas • " + concluidas + " concluídas");
        lblPrazo.setText("Etapas: " + projeto.getEtapas().size());
        lblMembros.setText("Equipe ativa");
    }
    ...
    private void initComponents() {
        ...
        setBorder(new javax.swing.border.LineBorder(javax.swing.UIManager.getDefaults().getColor("Button.borderColor"),
                2, true));
